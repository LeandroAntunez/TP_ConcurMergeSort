			...
			new Thread() {
		        ...
		        public synchronized void run() {
		        	...
		        	while(! buffer.isEmpty() ) {
		        		System.out.println("El " + this.getName() + " va a pedir un turno, " + "Tama�o buffer: " + buffer.size());
		        		pedirTurno();
		        		System.out.println("El " + this.getName() + " inicio un ciclo, " + "Tama�o buffer: " + buffer.size());
		        		...
		        		System.out.println("El " + this.getName() + " finalizo un ciclo, " + "Tama�o buffer: " + buffer.size());
		        		liberarTurno();
